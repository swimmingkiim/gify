// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 2.19.2.
...
(function dartProgram() {
  ...
  A._StructuredClone.prototype = {
    ...
    walk$1(e) {
      ...
      if (type$.Blob._is(e))
        return e;
      if (type$.NativeByteBuffer._is(e) || type$.NativeTypedData._is(e) || type$.MessagePort._is(e) || false)
        return e;
  ...
  A._AcceptStructuredClone.prototype = {
    ...
    walk$1(e) {
      var millisSinceEpoch, t1, proto, slot, copy, t2, map, l, $length, i, _this = this;
      if (e == null)
        return e;
      if (A._isBool(e))
        return e;
  ...
  A.main_closure.prototype = {
    ...
    $call$body$main_closure(e) {
      var $async$goto = 0,
        ...
        height, forceOriginalAspectRatio, textMessages, data, t2, path, fps, t1, width;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = J.$index$asx(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(e.data, true), "width");
              width = A._asInt(t1 == null ? -1 : t1);
              ...
              self.getGifFromVideo(path, fps, width, height, forceOriginalAspectRatio, textMessages, A.allowInterop(new A.main__closure(data, new A._AsyncCompleter(t1, type$._AsyncCompleter_dynamic)), type$.Function));
              $async$goto = 2;
  ...
  A.main__closure.prototype = {
    call$1(results) {
      var t1;
      type$.ByteBuffer._as(results);
      t1 = new Uint8Array(results, 0);
      this.data._value = t1;
...
//# sourceMappingURL=gif_repository_web_video_worker.dart.js.map
