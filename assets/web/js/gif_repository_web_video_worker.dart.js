  ...
  A.main_closure.prototype = {
    ...
    $call$body$main_closure(e) {
      var $async$goto = 0,
        ...
        height, forceOriginalAspectRatio, data, t2, path, fps, t1, width;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              self.getGifFromVideo(path, fps, width, height, forceOriginalAspectRatio, A.allowInterop(new A.main__closure(data, new A._AsyncCompleter(t1, type$._AsyncCompleter_dynamic)), type$.Function));
              $async$goto = 2;
