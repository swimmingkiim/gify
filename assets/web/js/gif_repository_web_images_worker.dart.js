...
(function dartProgram() {
      ...
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A.List_List$from(type$.Iterable_dynamic._as(J.$index$asx(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(e.data, true), "imagePaths")), type$.dynamic);
              t2 = A._arrayInstanceType(t1);
              t3 = t2._eval$1("MappedListIterable<1,List<String>>");
              imagePaths = A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("List<String>(1)")._as(new A.main__closure()), t3), true, t3._eval$1("ListIterable.E"));
              ...
              t3 = J.$index$asx(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(e.data, true), "width");
              width = A._asInt(t3 == null ? -1 : t3);
  ...
  A.main__closure.prototype = {
    call$1(path) {
      return A.List_List$from(type$.Iterable_dynamic._as(path), type$.String);
    },
    $signature: 21
  };
...
//# sourceMappingURL=gif_repository_web_images_worker.dart.js.map
