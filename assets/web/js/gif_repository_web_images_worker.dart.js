        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              self.getGifFromImages(imagePaths, fps, A.allowInterop(new A.main__closure0(data, new A._AsyncCompleter(t3, type$._AsyncCompleter_dynamic)), type$.Function));
              $async$goto = 2;
